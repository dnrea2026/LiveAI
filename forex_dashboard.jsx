  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <AreaChart data={chartData} margin={{top:10,right:8,bottom:0,left:8}}>
        ...
        <Tooltip contentStyle={{background:"#0f172a",border:"1px solid #1e293b",borderRadius:6,fontFamily:"monospace",fontSize:11}} labelStyle={{color:"#94a3b8"}} itemStyle={{color:color}}/>
...
export default function App() {
  ...
  const [tab, setTab] = useState("chart"); // chart|positions
  ...
  const connect = useCallback(() => {
    ...
    ws.onclose = () => { setWsStatus("disconnected"); if (!demoMode) startDemo(); };
  }, [wsUrl, timeframe, demoMode, startDemo]);
